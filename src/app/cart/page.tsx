...
export default function CartPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8">
      <h1 className="font-serif text-2xl sm:text-3xl text-espresso-800 mb-8 animate-fade-in-up">
      ...
      <div className="mt-8 bg-espresso-50/50 rounded-2xl border border-espresso-100/60 p-6">
        ...
        <button onClick={handleOrder} disabled={placing}
          className="w-full bg-burnt-500 text-white py-3.5 rounded-full text-sm font-semibold hover:bg-burnt-600 hover:shadow-lg hover:shadow-burnt-200/50 transition-all duration-300 disabled:opacity-50 disabled:hover:shadow-none">
